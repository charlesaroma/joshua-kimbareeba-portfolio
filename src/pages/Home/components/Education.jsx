...
const Education = () => {
  ...
  const education = [
    {
      ...
      icon: GraduationCap,
      accent: 'bg-accent',
      description: 'Focused on software engineering, database management, and enterprise systems.'
    },
    {
      ...
      icon: School,
      accent: 'bg-white/10',
      description: 'Physics, Economics, and Mathematics major.'
    },
    {
      ...
      icon: Book,
      accent: 'bg-white/5',
      description: 'General secondary education with a focus on science and technology.'
    }
  ];
  ...
  return (
    <section 
      ref={container} 
      id="education" 
      className="py-32 bg-primary text-bg overflow-hidden relative"
    >
        ...
        <div className="flex flex-col lg:flex-row items-start gap-20">
          ...
          <div className="lg:w-2/3 edu-list space-y-8">
            {education.map((item, index) => (
              <div
                key={index}
                className="edu-card group p-10 bg-white/[0.03] backdrop-blur-md border border-white/10 hover:bg-white/[0.06] transition-all duration-500 rounded-3xl cursor-default relative overflow-hidden"
              >
                {/* Accent Glow */}
